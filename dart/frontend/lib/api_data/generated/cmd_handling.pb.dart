...
class Update extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Update', package: const $pb.PackageName(_omitMessageNames ? '' : 'shrapnel.cmd_handling'), createEmptyInstance: create)
...
class Initialise extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Initialise', package: const $pb.PackageName(_omitMessageNames ? '' : 'shrapnel.cmd_handling'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Message', package: const $pb.PackageName(_omitMessageNames ? '' : 'shrapnel.cmd_handling'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<Update>(1, _omitFieldNames ? '' : 'update', subBuilder: Update.create)
    ..aOM<Initialise>(2, _omitFieldNames ? '' : 'initialise', subBuilder: Initialise.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set update(Update v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set initialise(Initialise v) { setField(2, v); }
  @$pb.TagNumber(2)
