...
class InputClipped extends $pb.GeneratedMessage {
  ...
  factory InputClipped.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InputClipped.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'InputClipped',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'shrapnel.audio_events'),
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  InputClipped copyWith(void Function(InputClipped) updates) =>
      super.copyWith((message) => updates(message as InputClipped))
          as InputClipped;
  ...
  static $pb.PbList<InputClipped> createRepeated() =>
      $pb.PbList<InputClipped>();
  @$core.pragma('dart2js:noInline')
  static InputClipped getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InputClipped>(create);
...
class OutputClipped extends $pb.GeneratedMessage {
  ...
  factory OutputClipped.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory OutputClipped.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'OutputClipped',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'shrapnel.audio_events'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  OutputClipped copyWith(void Function(OutputClipped) updates) =>
      super.copyWith((message) => updates(message as OutputClipped))
          as OutputClipped;
  ...
  static $pb.PbList<OutputClipped> createRepeated() =>
      $pb.PbList<OutputClipped>();
  @$core.pragma('dart2js:noInline')
  static OutputClipped getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<OutputClipped>(create);
  static OutputClipped? _defaultInstance;
}

enum Message_Event { inputClipped, outputClipped, notSet }
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<InputClipped>(1, _omitFieldNames ? '' : 'inputClipped',
        subBuilder: InputClipped.create)
    ..aOM<OutputClipped>(2, _omitFieldNames ? '' : 'outputClipped',
        subBuilder: OutputClipped.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  set inputClipped(InputClipped v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set outputClipped(OutputClipped v) {
    setField(2, v);
  }
