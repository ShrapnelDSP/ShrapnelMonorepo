...
void FMVFilter::reset() { filter.reset(); }
...
void FMVFilter::set_parameters(float l, float m, float t)
{
    ...
    float a1 = (C1 * R1 + C1 * R3 + C2 * R3 + C2 * R4 + C3 * R4) + m * C3 * R3 +
               l * (C1 * R2 + C2 * R2);
    ...
    float a2 = m * (C1 * C3 * R1 * R3 - C2 * C3 * R3 * R4 + C1 * C3 * R3 * R3 +
               ...
               l * m * (C1 * C3 * R2 * R3 + C2 * C3 * R2 * R3) -
               m * m * (C1 * C3 * R3 * R3 + C2 * C3 * R3 * R3) +
               l * (C1 * C2 * R2 * R4 + C1 * C2 * R1 * R2 + C1 * C3 * R2 * R4 +
                    C2 * C3 * R2 * R4) +
    ...
    filter.set_coefficients(
        std::array<float, 8>{B0, B1, B2, B3, A0, A1, A2, A3});
}
